...
Route::middleware(['auth:sanctum', 'throttle:api'])->group(function () {
    ...
    // =========================================================================
    // ERP — Rutas con validación de empresa (company middleware)
    // Garantiza que el usuario tenga company_id asignado y que no suplante otra empresa
    // =========================================================================
    Route::middleware('company')->group(function () {
        ...
        // Los reportes son queries pesadas; limitamos para proteger el servidor
